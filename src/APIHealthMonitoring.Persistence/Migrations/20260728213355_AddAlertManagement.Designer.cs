...
namespace APIHealthMonitoring.Persistence.Migrations
{
    ...
    [Migration("20260728213355_AddAlertManagement")]
    partial class AddAlertManagement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APIHealthMonitoring.Domain.Entities.Alert", b =>
                {
                    ...
                    b.HasIndex("ApiEndpointId", "Status", "Severity")
            ...
            modelBuilder.Entity("APIHealthMonitoring.Domain.Entities.HealthCheck", b =>
                {
                    ...
                    b.HasIndex("ApiEndpointId", "CheckedAt")
            ...
            modelBuilder.Entity("APIHealthMonitoring.Domain.Entities.MonitoringConfiguration", b =>
                {
                    ...
                    b.Property<decimal>("AvailabilityThreshold")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(5, 2)
                    ...
                    b.Property<int>("FailureCountLimit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(3);
